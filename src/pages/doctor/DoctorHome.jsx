// This component now acts as the "Overview" tab
function DoctorHome({ doctor, setActiveTab }) {
  // If doctor prop isn't passed (e.g. initial load), handle gracefully
